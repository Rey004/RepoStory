        ...
        <div className="flex items-center gap-3 min-w-0 flex-1">
          ...
          >
            <img
              ...
              className={`w-28 h-28 rounded-full border-2 object-cover ${isLightMode ? "border-white" : "border-black"}`}
            />
          </div>
          <div className="min-w-0 text-left">
            <div className="flex items-center gap-1.5 font-mono text-[13px] font-extrabold">
              ...
              <span className={isLightMode ? "text-zinc-700" : "text-white"}>{repoDetails.name}</span>
            </div>
            <h1 className={`text-xl font-medium tracking-tight font-display truncate mt-0.5 ${isLightMode ? "text-zinc-900" : "text-white"}`}>
              {repoDetails.name}
            </h1>
